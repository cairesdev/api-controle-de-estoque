module.exports = {
 ...
 `,
  ...
  getEstoque: `SELECT EU.CODIGO, EU.NOME, EU.DATA_ENTRADA, EU.QNT_ENTRADA, EU.QNT_DISPONIVEL, EU.LOCAL_ESTOCADO, U.NOME AS "solicitante", S.DATA_SOLICITACAO, SS.NOME AS "status", UD.nome as "despachante"
  FROM ESTOQUE_UNIDADE EU
  JOIN SOLICITACAO S ON EU.ID_SOLICITACAO = S.ID
  JOIN USUARIO U ON S.ID_SOLICITANTE = U.ID
