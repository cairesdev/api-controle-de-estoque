module.exports = {
  ...
  JOIN TIPO_ESTOQUE TE ON S.ID_TIPO_ESTOQUE = TE.ID 
  JOIN UNIDADE UND ON S.ID_UNIDADE = UND.ID
  WHERE S.ID_UNIDADE = $1 AND S.id_status = 'd915a72e-09ae-49af-926d-a0c399fd1aba' OR S.ID_ORGAO = $1 AND S.id_status = 'd915a72e-09ae-49af-926d-a0c399fd1aba' ORDER BY S.DATA_SOLICITACAO;
  `,
