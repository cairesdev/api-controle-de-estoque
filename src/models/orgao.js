module.exports = {
  ...
  getEstoque: `SELECT AO.ID, AO.CODIGO, AO.NOME AS "nome_remessa", AO.DATA_ENTRADA, AO.LOCAL_ESTOCADO, TE.NOME as "tipo_estoque"
  FROM ARMAZEM_ORGAO AO 
  JOIN TIPO_ESTOQUE TE ON AO.ID_TIPO_ESTOQUE = TE.ID
  WHERE ID_ORGAO = $1 ORDER BY AO.DATA_ENTRADA DESC;`,

  getEstoqueUnidade: `SELECT EU.ID, EU.CODIGO, EU.NOME AS "nome_remessa", EU.DATA_ENTRADA, EU.LOCAL_ESTOCADO, TE.NOME as "tipo_estoque"
